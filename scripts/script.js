...
function recalculate(modelName, duration) {
  ...
  if (modelName.includes("XYZ")) {
    calculatedCost = duration * 100;
  } else if (modelName.includes("CPRG")) {
...
function changeDuration() {
  ...
  let durationStr = prompt("Enter new duration:");
  let durationNum = parseInt(durationStr);
  durationText.innerHTML = durationNum;
  recalculate(modelName, durationNum);
